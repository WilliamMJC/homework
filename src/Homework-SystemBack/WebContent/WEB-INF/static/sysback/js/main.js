layui.config({
	base : "${pageContext.servletContext.contextPath}/static/sysback/js/"
	...
	$.get("../../static/sysback/json/newsList.json",
		function(data){
			var waitNews = [];
	...
	//图片总数
	$.get("../../static/sysback/json/images.json",
		function(data){
	...
	//用户
	$.get("../../static/sysback/json/usersList.json",
		function(data){
	...
	//新消息
	$.get("../../static/sysback/json/message.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "../../static/sysback/json/systemParameter.json",
			type : "get",
			dataType : "json",
