layui.config({
	...
	//加载页面数据
	var listData = '';
	$.get("../../sysback/course/getCourseList", function(data){
		var newArray = [];
		//单击首页“待审核文章”加载的信息
		...
		function renderDate(data,curr){
			...
			if(currData.length != 0){
				for(var i=0;i<currData.length;i++){
			    	...
			    	+'<td align="left">'+currData[i].courseName+'</td>'
			    	...
			    	dataHtml += '<td>'+currData[i].teacherName+'</td>'
			    	...
			    	+'<td>'+currData[i].createTime+'</td><td>'			    	
