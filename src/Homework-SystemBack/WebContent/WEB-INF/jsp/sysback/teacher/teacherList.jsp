...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		...
		<div class="layui-inline" style='float:right'>
			<a class="layui-btn layui-btn-normal newsAdd_btn layui-btn-small">添加教师</a>
		</div>		
	</blockquote>
	...
	<script type="text/javascript" src="${pageContext.servletContext.contextPath}/static/sysback/js/teacherList.js"></script>
</body>
</html>