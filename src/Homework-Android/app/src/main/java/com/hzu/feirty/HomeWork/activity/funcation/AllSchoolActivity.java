...
import com.hzu.feirty.HomeWork.activity.mycenter.UserSchoolUpdateActivity;
...
public class AllSchoolActivity extends AppCompatActivity {
    ...
    public void findAllSchool() {
        ...
        String token = PreferencesUtil.getSharedStringData(AllSchoolActivity.this,"token");
        params.put("token", token);
        AsyncHttpClient client = new AsyncHttpClient();
        client.setConnectTimeout(50000);
        client.setTimeout(50000);
        String url2 = "http://192.168.10.168:8080/email-homework/api/school/getAllSchool";
