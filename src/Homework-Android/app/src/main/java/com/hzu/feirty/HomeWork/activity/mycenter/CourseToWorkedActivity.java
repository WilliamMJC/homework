...
public class CourseToWorkedActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    recyclerview.setLayoutManager(new LinearLayoutManager(CourseToWorkedActivity.this));
                    recyclerview.addItemDecoration(new MyItemDecoration());
                    recyclerAdapter =  new CourseAdapter(CourseToWorkedActivity.this,cData,onRecyclerviewItemClickListener);
    ...
    private OnRecyclerviewItemClickListener onRecyclerviewItemClickListener = new OnRecyclerviewItemClickListener() {
        ...
        public void onItemClickListener(View v, int position) {
            ...
            final Intent intent = new Intent(CourseToWorkedActivity.this, ConstructionWorkedActivity.class).putExtra("course", cData.get(position).getName());
    ...
    public void findCourse() {
        ...
        String user = PreferencesUtil.getSharedStringData(CourseToWorkedActivity.this,"username");
        ...
        client.post(url, params, new AsyncHttpResponseHandler() {
                ...
                if (str != null) {
                    try {
                        ...
                        if (object.getString("code").equals("success")) {
                            ...
                            Toast.makeText(CourseToWorkedActivity.this,"课程接收成功",Toast.LENGTH_SHORT).show();
                            myHandler.obtainMessage(1).sendToTarget();
                        } else {
                            Toast.makeText(CourseToWorkedActivity.this,"课程接收失败",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int i, org.apache.http.Header[] headers, byte[] bytes, Throwable throwable) {
                Toast.makeText(CourseToWorkedActivity.this, "网络连接失败，请查看网络设置", Toast.LENGTH_SHORT).show();
                myHandler.obtainMessage(0).sendToTarget();
            }
        });
    }
