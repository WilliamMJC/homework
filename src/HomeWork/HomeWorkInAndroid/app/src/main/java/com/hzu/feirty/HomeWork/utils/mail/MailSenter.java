...
public class MailSenter {
    ...
    // public static MailSenter getInstance(SendWorkActivity context) {
    // if (instance == null) {
     ...
     * @throws Exception
     */
    public void send(String mailTo, String mailSubject, String mailBody, ArrayList<String> attachments,
