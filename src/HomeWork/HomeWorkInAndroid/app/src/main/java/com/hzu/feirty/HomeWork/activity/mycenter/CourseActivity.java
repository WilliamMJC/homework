...
public class CourseActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    recyclerAdapter =  new CourseAdapter(CourseActivity.this,cData,onRecyclerviewItemClickListener);
    ...
    private OnRecyclerviewItemClickListener onRecyclerviewItemClickListener = new OnRecyclerviewItemClickListener() {
        ...
        public void onItemClickListener(View v, int position) {
            ...
            final Intent intent = new Intent(CourseActivity.this, WorkActivity.class).putExtra("course", cData.get(position).getName());
    ...
    public void findCourse() {
        ...
        String user = PreferencesUtil.getSharedStringData(CourseActivity.this,"username");
        ...
        client.post(url, params, new AsyncHttpResponseHandler() {
                ...
                if (str != null) {
                    try {
                        ...
                        if (object.getString("code").equals("success")) {
                            ...
                            Toast.makeText(CourseActivity.this,"课程接收成功",Toast.LENGTH_SHORT).show();
                            myHandler.obtainMessage(1).sendToTarget();
                        } else {
                            Toast.makeText(CourseActivity.this,"课程接收失败",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int i, org.apache.http.Header[] headers, byte[] bytes, Throwable throwable) {
                Toast.makeText(CourseActivity.this, "网络连接失败，请查看网络设置", Toast.LENGTH_SHORT).show();
                myHandler.obtainMessage(0).sendToTarget();
            }
        });
    }
