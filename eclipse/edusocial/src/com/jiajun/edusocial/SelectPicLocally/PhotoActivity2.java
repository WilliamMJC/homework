...
import com.jiajun.edusocial.SelectPicLocally.PhotoActivity.MyPageAdapter;
...
public class PhotoActivity2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		photo_bt_exit.setVisibility(View.VISIBLE);
...
//				intent2.putExtra("picPathPassBack", Bimp.drr.get(0));
