...
public class selectPicFromAlbum extends Activity {
	...
	private void initView() {
		...
		adapter = new ImageBucketAdapter(selectPicFromAlbum.this, dataList);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(selectPicFromAlbum.this,
