...
import com.jj.tmdemo.Search4me;
import com.jj.tmdemo.personalInfo;
import com.jj.tmdemo.pubHW;
import com.jj.tmdemo.pubInform;
import com.jj.tmdemo.pubPhoto;
...
public class MainUI4me extends FragmentActivity {
	...
	DatabasePart dp;
	String S4getYourIdentity;
	String S4YourIdentity;
	Cursor C4getYourIdentity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		S4getYourIdentity = "select identity from user where nickname = ?";
		dp = new DatabasePart("jim/sjk", "a1.db");
		C4getYourIdentity = dp.query(S4getYourIdentity, new String[]{userNickName});
		C4getYourIdentity.moveToFirst();
		S4YourIdentity = C4getYourIdentity.getString(0);
		C4getYourIdentity.close();
	}
	public void onAdditionClick(View imageview)
	{
		...
		if (S4YourIdentity.equals("teacher")) {
...
//					break;
				case R.id.pubHomeworkMenu:
					...
					bundle4menuPubHW.putString("userName", userNickName);
				...
				case R.id.pubInformMenu:
					...
					bundle4menuPubInform.putString("userName", userNickName);
	...
	public void onSearchClick(View imageview)
	{
		...
		intent.setClass(MainUI4me.this, Search4me.class);
		...
		popup4more.setOnMenuItemClickListener(new OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				...
				case R.id.personalInfo:
					...
					break;
				case R.id.exit:
					//Toast.makeText(MainUI4me.this, "退出", Toast.LENGTH_SHORT).show();
					finish();
					break;
//				default:
//					break;
